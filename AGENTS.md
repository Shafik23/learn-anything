...
- `reference/` - printable quick-reference documents
...
- Name lessons as `lessons/0001-short-dash-case-title.html`, incrementing the number.
- Name reference pages as `reference/0001-short-dash-case-title.html`, incrementing the number.
